...
INTERACT_CHECK = ButtonWrapper(
    ...
    share=[
        ...
        Button(
            file='./assets/share/base/page/INTERACT_CHECK.3.png',
            area=(44, 117, 98, 150),
            search=(24, 97, 118, 170),
            color=(225, 184, 88),
            button=(44, 117, 98, 150),
        ),
    ],
)
...
JINGEYANWU_GOTO_NO_REWARD_PREPARE = ButtonWrapper(
    name='JINGEYANWU_GOTO_NO_REWARD_PREPARE',
    share=Button(
        file='./assets/share/base/page/JINGEYANWU_GOTO_NO_REWARD_PREPARE.png',
        area=(964, 632, 1101, 680),
        search=(944, 612, 1121, 700),
        color=(236, 179, 114),
        button=(964, 632, 1101, 680),
    ),
)
JINGEYANWU_GOTO_PREPARE = ButtonWrapper(
    name='JINGEYANWU_GOTO_PREPARE',
    share=Button(
        file='./assets/share/base/page/JINGEYANWU_GOTO_PREPARE.png',
...
JINGEYANWU_GOTO_SHOP = ButtonWrapper(
    name='JINGEYANWU_GOTO_SHOP',
    share=Button(
        file='./assets/share/base/page/JINGEYANWU_GOTO_SHOP.png',
        area=(46, 272, 109, 324),
        search=(26, 252, 129, 344),
        color=(182, 143, 112),
        button=(46, 272, 109, 324),
    ),
)
JINGEYANWU_PREPARE_CHECK = ButtonWrapper(
    name='JINGEYANWU_PREPARE_CHECK',
    share=Button(
        file='./assets/share/base/page/JINGEYANWU_PREPARE_CHECK.png',
        area=(94, 16, 167, 48),
        search=(74, 0, 187, 68),
        color=(174, 96, 84),
        button=(94, 16, 167, 48),
...
TAOYUAN_GAME_CHECK = ButtonWrapper(
    ...
    share=[
        ...
        Button(
            file='./assets/share/base/page/TAOYUAN_GAME_CHECK.2.png',
            area=(47, 117, 86, 152),
            search=(27, 97, 106, 172),
            color=(212, 157, 104),
            button=(47, 117, 86, 152),
        ),
    ],
)
