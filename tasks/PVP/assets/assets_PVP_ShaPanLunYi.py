...
FLAG_OCR = ButtonWrapper(
    name='FLAG_OCR',
    share=Button(
        file='./assets/share/pvp/ShaPanLunYi/FLAG_OCR.png',
        area=(863, 18, 952, 44),
        search=(843, 0, 972, 64),
        color=(78, 59, 49),
...
GET_REWARD_CONFIRM = ButtonWrapper(
    ...
    share=Button(
        file='./assets/share/pvp/ShaPanLunYi/GET_REWARD_CONFIRM.png',
...
REFRESH = ButtonWrapper(
    name='REFRESH',
    share=Button(
        file='./assets/share/pvp/ShaPanLunYi/REFRESH.png',
...
REFRESH_CONFIRM = ButtonWrapper(
    ...
    share=Button(
        file='./assets/share/pvp/ShaPanLunYi/REFRESH_CONFIRM.png',
