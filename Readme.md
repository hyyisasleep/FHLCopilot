# 忘川打工助手/Lethe Work Assistant

忘川风华录 自动化日常脚本

基于[SRC](https://github.com/LmeSzinc/StarRailCopilot/)/ [AzurLaneAutoScript](https://github.com/LmeSzinc/AzurLaneAutoScript)框架开发（但是抛弃了大部分功能变成按键精灵
...
每日每周一起买，设定个优先级 每日> 每周，道具不够了就优先买每日
...
* **悬赏**
  ...
  击杀5个镜之心魔/蚌精 = 两次镜渊或3次宝墟

  抽卡1次（优先用普通抽。。。他们五百天老登是不是有每日免费

  给xxx朋友圈点赞三次（原地点取消点六次
